...
public class StringUtils {
	 ...
	 * @return
	 */
	public static String replaceStr(String oldstr,Integer startIndex,Integer endIndex,String replaceStr) {
		String substring = oldstr.substring(startIndex, endIndex);
		StringBuffer sb = new StringBuffer();
		for(int i = 0;i<substring.length();i++) {
			sb = sb.append(replaceStr);
		}
		oldstr = oldstr.replace(substring, sb);
		return oldstr;
	}
}
